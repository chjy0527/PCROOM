...
public class SnackController extends Controllers {
	private FoodDAO foodMapper;
	List<OrderList> oList;

	public SnackController(List<OrderList> oList) {
		this.oList = oList;
	...
	public void service() {
		System.out.println("과자류를 선택했습니다.");
		System.out.println();
		List<Food> fList = foodMapper.selectFoodList(2);
